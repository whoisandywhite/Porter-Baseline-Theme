...
class baseline_ThemeScripts
{
	...
	{
		?>
		<!-- baseline header tracking scripts -->
		<?php 
	}
	...
	public function footer_scripts() : void
	{
		...
		if( 'production' != wp_get_environment_type() ) echo sprintf('<div style="background:gray;padding:0.5rem;color:white;font-size:0.8rem;">Current Version: %s</div>', wp_get_theme()->get('Version'));
